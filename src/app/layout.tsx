...
export const metadata: Metadata = {
  title: "Smakokota Restaurant | Fine Dining Experience",
  description: "Discover exceptional fine dining at Smakokota. Experience authentic cuisine, elegant ambiance, and impeccable service. Reserve your table today.",
  keywords: "restaurant, fine dining, reservations, cuisine, gourmet",
  metadataBase: new URL("https://smakokota.com"),
  alternates: {
    canonical: "https://smakokota.com"
  },
  openGraph: {
    title: "Smakokota Restaurant | Fine Dining Experience",
    description: "Experience exceptional dining at Smakokota. Reserve your table for an unforgettable evening.",
    siteName: "Smakokota",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Smakokota Restaurant",
    description: "Discover fine dining excellence at Smakokota. Book your reservation now."
  }
};
